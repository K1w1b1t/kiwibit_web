    ...
    <section className="rounded-xl border border-[var(--surface-border)] bg-[var(--surface-card)] p-4">
      <div className="mb-3 flex items-center justify-between">
        ...
        <button
          ...
          className="rounded border border-[var(--surface-border)] px-3 py-1 text-[10px] uppercase tracking-[0.12em]"
        >
          Reindex Embeddings
        </button>
      </div>
      ...
      {summary ? (
        <pre className="mt-3 whitespace-pre-wrap rounded border border-[var(--surface-border)] p-3 text-xs text-[var(--text-soft)]">
          {summary}
        </pre>
      ) : null}
      {results.length > 0 ? (
