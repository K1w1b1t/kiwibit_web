  ...
  useEffect(() => {
    const onLeave = () => {
      ...
      navigator.sendBeacon(
        ...
        JSON.stringify({ type: 'post_dwell', slug, ms, visitorId: getVisitorId() }),
      );
    };
  ...
  return (
    <section className="mt-16 space-y-10">
      ...
      <form
        ...
        className="rounded-xl border border-[var(--surface-border)] bg-[var(--surface-card)] p-6"
      >
        ...
        <div className="mt-4 grid gap-3 md:grid-cols-2">
          <input
            ...
            placeholder="Name"
            required
            className="rounded border border-[var(--surface-border)] bg-black/30 px-3 py-2 text-sm"
          />
          <input
            type="email"
            value={email}
        ...
        <textarea
          ...
          required
          rows={4}
          className="mt-3 w-full rounded border border-[var(--surface-border)] bg-black/30 px-3 py-2 text-sm"
        />
