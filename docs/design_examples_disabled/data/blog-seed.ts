...
export const BLOG_SEED_POSTS: BlogPost[] = [
  {
    ...
    excerpt:
      'How to map identities, devices, and service boundaries without creating operational drag.',
    coverImage:
...
Track failed authorization attempts and policy drift per team.`,
  },
  {
    ...
    excerpt:
      'A pragmatic playbook for triage, containment, and post-incident learning in under 5 pages.',
    coverImage:
