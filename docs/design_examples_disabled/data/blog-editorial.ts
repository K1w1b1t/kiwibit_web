export const BLOG_FIXED_CATEGORIES = [
  'Architecture',
  'Operations',
  'Engineering',
  'Threat Intel',
...
export const BLOG_EDITORIAL_CALENDAR = [
  {
    period: 'Week 1',
    theme: 'Threat Intelligence Brief',
    focus: 'Emerging vectors, IOCs, and mitigation checklist.',
  },
  {
    period: 'Week 2',
    theme: 'Deep Technical Post',
    focus: 'Architecture decision, benchmarks, and implementation guide.',
  },
  {
    period: 'Week 3',
    theme: 'Incident Case Study',
    focus: 'Timeline, root cause, containment, and lessons learned.',
  },
  {
    period: 'Week 4',
    theme: 'Operational Playbook',
    focus: 'Runbook, SLOs, and automation opportunities.',
  },
] as const;
