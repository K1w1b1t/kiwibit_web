  ...
  return [
    {
      ...
      image:
        'https://images.unsplash.com/photo-1557683316-973673baf926?q=80&w=700&auto=format&fit=crop',
...
export const MEMBERS_BY_ID: Record<string, Member> = {
  'gustavo-costa': {
    ...
    achievements: [
      'Led 30+ web security audits',
      'Reduced critical findings by 45%',
      'Built internal offensive tooling',
    ],
  ...
  'pedro-galvao': {
    ...
    achievements: [
      'Implemented secure coding checklist',
      'Documented incident playbooks',
      'Improved triage response times',
    ],
  ...
  'marcio-souza': {
    ...
    achievements: [
      'Cut query latency by 60%',
      'Designed HA backup strategy',
      'Hardened access control policies',
    ],
  ...
  'pedro-souza': {
    ...
    achievements: [
      'Shipped multiplatform MVPs',
      'Unified web/mobile design system',
      'Raised release cadence',
    ],
  ...
  'thiago-maia': {
    ...
    achievements: [
      ...
      'Built internal tooling prototypes',
    ],
  ...
  henrique: {
    ...
    clearance: 'L-04',
    avatar:
      'https://images.unsplash.com/photo-1504593811423-6dd665756598?q=80&w=400&h=400&auto=format&fit=crop',
    skills: [
    ...
    achievements: [
      'Deployed SOC alerts at scale',
      'Lowered MTTR across incidents',
      'Created detection rule library',
    ],
  ...
  'italo-bianchi': {
    ...
    clearance: 'L-02',
    avatar:
      'https://images.unsplash.com/photo-1521119989659-a83eee488004?q=80&w=400&h=400&auto=format&fit=crop',
    skills: [
    ...
    achievements: [
      'Built secure IoT prototypes',
      'Improved firmware resilience',
